        ...
        pkg.bump && !pkg.easyUpgrade
            ? [
                chalk.white.bold.bgGreen((
                    pkg.bump === 'nonSemver' ? emoji(' :sunglasses: ') + ' new ver! '.toUpperCase() : emoji(' :sunglasses: ') + ' ' + pkg.bump.toUpperCase() + ' UP ')) + ' ' + uppercaseFirstLetter(pkg.bump) + ' update available. ' + chalk.blue.underline(pkg.homepage || ''),
                indent + upgradeMessage,
            ]
            : '',
        pkg.unused
            ? [
                ...
                indent + `To remove this package: ${chalk.green(isYarn
